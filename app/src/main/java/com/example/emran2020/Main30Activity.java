...
public class Main30Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id=findViewById ( R.id.id1010 );

    }

    public void next5012(View view) {


        if (TextUtils.isEmpty ( id.getText ().toString () )) {
            Toast.makeText ( Main30Activity.this, "Insert Id",
        ...
        if (id.getText ().toString ().length () != 9) {
            Toast.makeText ( Main30Activity.this, " Id should be 9 numbers",
                    Toast.LENGTH_SHORT ).show ();
        ...
        query.addListenerForSingleValueEvent ( new ValueEventListener () {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists ()) {
                    GlobalClass.updateId=id.getText ().toString ();
                    Intent intent =new Intent ( Main30Activity.this,Main14Activity.class );
                    startActivity ( intent);
                }
                else{
                    AlertDialog.Builder builder= new AlertDialog.Builder ( Main30Activity.this );
